<!--  -->
<template>
  <div class="detailComentinfo" v-if="Object.keys(commentInfo).length!==0" >
    <div>
      <h1 style="  text-align: center;">用户评论</h1>
    </div>
    <div class="info-user">
